...
A PHP protobuf generation compatibility checker that validates protoc/plugin outputs against fixture schemas.
...
- `protoc-gen-php fork` — source inspiration: https://github.com/vincentkoc/protoc-gen-php (C++/PHP, stars/forks signal: 1).
...
- Compile fixture proto files
- Compare generated PHP snapshots
- Report plugin/version mismatches
...
protobridge-php inspect ./fixtures/sample --output ./out
```
...
Build `protobridge-php` as a renamed, local-first OSS idea inspired by `protoc-gen-php fork`. Preserve attribution, avoid direct copying, and focus V1 on deterministic fixtures, clear safety boundaries, and practical agent/developer workflow value.
