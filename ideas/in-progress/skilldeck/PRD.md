...
Release candidate PR: https://github.com/rogerchappel/skilldeck/pull/8

Outcome: Added strict-mode validation for portable SKILL.md sections, expanded fixtures, and documented the stricter contract.
