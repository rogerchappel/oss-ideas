...
Decision: ship
Updated: 2026-06-27
Repo: https://github.com/rogerchappel/skill-permission-matrix
...
- Include tests for extraction, warnings, config behavior, and Markdown rendering.
...
skill-permission-matrix scan fixtures/skills --config skill-permission-matrix.json --format json
```
...
- `npm run build`
- `npm run smoke`
- Fixture smoke that scans multiple skills and reports at least one warning.

## Source Attribution

Inspired by Roger's public skill packaging, release-gate, and connector-safety workflows. Build as original deterministic OSS tooling for agent-skill review.
